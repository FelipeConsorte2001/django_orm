    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('numero', models.CharField(help_text='Informe no máximo 16 caracteres', max_length=16, verbose_name='Chassi')),
            ],
            options={
                'verbose_name': 'Chassi',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('modelo', models.CharField(help_text='Informe no máximo 16 caracteres', max_length=30, verbose_name='Modelo')),
